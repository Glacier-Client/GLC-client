...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof GlacierMainMenu)
        {
            this.updateMainMenu((GlacierMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(GlacierMainMenu p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = GlacierMainMenu.class.getDeclaredFields();
