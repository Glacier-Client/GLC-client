package net.glacierclient.mod.ui.clientsettings.hudposconfig.comp;
...
public class DraggableComponent {
    ...
    public DraggableComponent(int x, int y, int width, int height, int color, String name, boolean enable){
        this.width = width;
        this.height = height;
        this.x = x;
        this.y = y;
